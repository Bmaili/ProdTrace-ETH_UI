  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="batchList" stripe>
      ...
      <el-table-column label="最新流程" align="center">
        <template slot-scope="scope">{{ statusOptions[scope.row.status].dictLabel }}</template>
      </el-table-column>
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="产品类别" prop="category">
              <el-input v-model="categoryOptions[form.category].dictLabel" disabled/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
import {addCreaterFlow} from "@/api/flow";
  ...
  methods: {
    ...
    submitForm: function () {
      this.$refs["form"].validate(valid => {
        if (valid) {
          addCreaterFlow(this.form).then(response => {
